...
public class Materia {
    ...
    public static void main(String[] args) {
        ...
        Alumno alumno1 = new Alumno("Juan", "Pérez", LocalDate.of(2005, 5, 15), "Estado 604", 0.00, Division.QUINTO_A, listaNotas1, listaMaterias1);
        Alumno alumno2 = new Alumno("María", "García", LocalDate.of(2003, 10, 20), "Carabobo 1874", 0.00, Division.CUARTO_B, listaNotas2, listaMaterias2);
        ...
        Alumno alumnoNuevo = new Alumno("Carlos", "Sánchez", LocalDate.of(2000, 1, 1), "Duhalde 3244", 0.00, Division.QUINTO_B, listaNotas3, listaMaterias3);
