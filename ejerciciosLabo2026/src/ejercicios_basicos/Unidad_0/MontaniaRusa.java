package ejercicios_basicos.Unidad_0;
...
public class MontaniaRusa {
    public static void main(String[] args){
        ...
        if (alerta > 0){
            System.out.println("¡ALERTA! Hay " + alerta + " seres_vivos/s que no cumple/n con la altura reglamentaria (1,40). Por favor, retirarse de la atracción");
        }
    }
}